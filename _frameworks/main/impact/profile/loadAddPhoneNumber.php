<form id="frm_add_phone_number" name="frm_add_phone_number" method="POST">
    ...
    <div class="formdiv verify_phone_number_form" id="verifyPhone">
        ...
        <button type="button" id="cNumber_submit" onclick="return Profile.submit_add_phone_number()" style="padding: 0 15px;text-transform: capitalize" class="btn small turquoise" disabled><?php echo l('save'); ?></button>
    </div>
</form>
