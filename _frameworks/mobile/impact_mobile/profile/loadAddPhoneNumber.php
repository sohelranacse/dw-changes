...
<form id="frm_add_phone_number" name="frm_add_phone_number" method="POST">
    ...
    <div class="bl arrow">
        <div class="title"><?php echo l('add_phone_number_title'); ?>
        <div class="cl"></div>
        </div>
    </div>
    ...
    <div class="bl_frm verify_phone_number_form" id="verifyPhone">
        ...
        <div class="bl" style="display: flex;justify-content: space-between;">
            ...
            <button type="button" id="cNumber_submit" onclick="return clProfile.addPhoneNumber()" style="padding: 0 15px;text-transform: capitalize;width: 37%" class="btn small turquoise" disabled><?php echo l('save'); ?></button>
        </div>
